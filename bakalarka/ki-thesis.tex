...
\usepackage[utf8]{inputenc}   % doporučeno místo CP1250
...
\usepackage{enumitem}
\setlist[enumerate,1]{label=\arabic*.} % první úroveň = 1.,2.,3.
\setlist[enumerate,2]{label=\alph*)}    % druhá úroveň = a), b), c)
...
\addchap*{Úvod}   % hvězdička odstraní číslování
\addcontentsline{toc}{chapter}{Úvod}  % explicitně přidá do obsahu

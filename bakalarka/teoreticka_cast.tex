...
Sterner a Stadler (2019) ve své  zdůrazňují, že energetická data jsou
...
\cite{Prince2023} dále zdůrazňuje, že časové řady jsou typickým příkladem sekvenčních dat, tedy dat, u nichž pořadí jednotlivých hodnot hraje zásadní roli. Na rozdíl od klasického statistického přístupu 
...
ale také na předchozím stavu sítě, což jim umožňuje uchovávat informaci o minulých hodnotách a využívat ji při predikci. \cite{Prince2023} upozorňuje, že RNN dokáží zachytit krátkodobé závislosti mezi jednotlivými 
prvky sekvence, avšak při práci s dlouhými sekvencemi trpí problémem vyhasínajících gradientů, což omezuje jejich schopnost uchovávat dlouhodobý kontext.
